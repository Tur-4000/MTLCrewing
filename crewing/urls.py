...
urlpatterns = [
    ...
    path('seaman/<int:seaman_id>/card/',
         views.seamancard,
         name='seamancard'),
    path('seaman/add/', views.seaman_add, name='seaman_add'),
    path('seaman/<int:seaman_id>/edit/',
         views.seaman_edit,
         name='seaman_edit'),
    path('seaman/<int:seaman_id>/contract/add/',
         views.contract_add,
         name='contract_add'),
    path('seaman/<int:seaman_id>/contract/<int:contract_id>/edit/',
         views.contract_edit,
         name='contract_edit'),
    ...
    path('vessel/<int:vessel_id>/edit/',
         views.vessel_edit,
         name='vessel_edit'),
    path('officer/list/', views.officer_list, name='officer_list'),
    path('officer/add/', views.officer_add, name='officer_add'),
    path('officer/<int:officer_id>/add/',
         views.officer_edit,
         name='officer_edit'),
]
